...
//    NSDictionary *head = [dic objectForKey:@"head"];
//    driTeachersList.issuccess = [head objectForKey:@"issuccess"];
...
//        DriTeaListInfo *driTeaListInfo = [[DriTeaListInfo alloc]init];
...
//    ExamSchedule *examSchedule = [[ExamSchedule alloc]init];
//    NSDictionary *head = [dic objectForKey:@"head"];
//    examSchedule.issuccess = [head objectForKey:@"issuccess"];
//    examSchedule.statecode = [head objectForKey:@"statecode"];
//    examSchedule.stateinfo = [head objectForKey:@"stateinfo"];
//    NSArray *examScheduleArr = [dic objectForKey:@"body"];
//    examSchedule.stuExamSchedules = [NSMutableArray array];
//    for (NSDictionary *examDic in examScheduleArr) {
//        ExamScheduleInfo *examScheduleInfo = [[ExamScheduleInfo alloc]init];
//        
//        examScheduleInfo.tz_id = [examDic objectForKey:@"tz_id"];
//        examScheduleInfo.tz_name = [examDic objectForKey:@"tz_name"];
//        
//        [examSchedule.stuExamSchedules addObject:examScheduleInfo];
//    }
//    return examSchedule;
//}
//预约记录
...
//    NSDictionary *head = [dic objectForKey:@"head"];
//    share.issuccess = [head objectForKey:@"issuccess"];
...
//    NSDictionary *head = [dic objectForKey:@"head"];
//    teacherTime.issuccess = [head objectForKey:@"issuccess"];
...
//        tePeriodListInfo.bookDate = [periodDic objectForKey:@"bookDate"];
...
//    TeacherPeriodDate *techerPeriodDate = [[TeacherPeriodDate alloc]init];
//    NSDictionary *head = [dic objectForKey:@"head"];
//    techerPeriodDate.issuccess = [head objectForKey:@"issuccess"];
//    techerPeriodDate.statecode = [head objectForKey:@"statecode"];
//    techerPeriodDate.stateinfo = [head objectForKey:@"stateinfo"];
//    NSArray *dateArr = [dic objectForKey:@"body"];
//    techerPeriodDate.teacherPeriodDates = [NSMutableArray array];
//    for (NSDictionary *dateDic in dateArr) {
//        TeacherPeriodDateInfo *teacherPeriodDateInfo = [[TeacherPeriodDateInfo alloc]init];
//        teacherPeriodDateInfo.bookDate = [dateDic objectForKey:@"yue_date"];
//        [techerPeriodDate.teacherPeriodDates addObject:teacherPeriodDateInfo];
//        
//    }
//    return techerPeriodDate;
//    
//}
//
////对教练的评价
//+(TeacherAppraised *)parserTeacherAppraisedByDictionary:(NSDictionary *)dic{
//    TeacherAppraised *teacherAppraised = [[TeacherAppraised alloc]init];
//    NSDictionary *head = [dic objectForKey:@"head"];
//    teacherAppraised.issuccess = [head objectForKey:@"issuccess"];
//    teacherAppraised.statecode = [head objectForKey:@"statecode"];
//    teacherAppraised.stateinfo = [head objectForKey:@"stateinfo"];
//    NSArray *dataArr = [dic objectForKey:@"body"];
//    teacherAppraised.teacherAppraisedDatas = [NSMutableArray array];
//    for (NSDictionary *dataDic in dataArr) {
//        TeacherAppraisedInfo *teacherAppraisedInfo = [[TeacherAppraisedInfo alloc]init];
//        teacherAppraisedInfo.code = [dataDic objectForKey:@"code"];
//        teacherAppraisedInfo.teacherID = [dataDic objectForKey:@"id"];
//        teacherAppraisedInfo.score = [dataDic objectForKey:@"score"];
//        teacherAppraisedInfo.appraiseContent = [dataDic objectForKey:@"pingjiacontent"];
//        teacherAppraisedInfo.appraiseTime = [dataDic objectForKey:@"pingjiatime"];
//        teacherAppraisedInfo.appraiseType = [dataDic objectForKey:@"pingjiatype"];
//        teacherAppraisedInfo.px_type = [dataDic objectForKey:@"px_type"];
//        teacherAppraisedInfo.per_name = [dataDic objectForKey:@"per_name"];
//        [teacherAppraised.teacherAppraisedDatas addObject:teacherAppraisedInfo];
//        
//    }
//    return teacherAppraised;
//   
//}
////学员考试明细
...
//    NSDictionary *head = [dic objectForKey:@"head"];
//    studentExamContent.issuccess = [head objectForKey:@"issuccess"];
...
//    NSDictionary *head = [dic objectForKey:@"head"];
//    dynamicPeriodList.issuccess = [head objectForKey:@"issuccess"];
